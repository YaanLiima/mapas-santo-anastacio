...
return [
    "text:home-header.title" => i::__("Boas-vindas ao Mapa Cultural de Santo Anastácio"),
    "text:home-header.description" => i::__("O Mapa Cultural de Santo Anastácio é uma ferramenta de gestão cultural que garante a estruturação de Sistemas de Informações e Indicadores. A plataforma oferece soluções para o mapeamento colaborativo de agentes culturais, realização de todas as etapas de editais e fomentos, organização de uma agenda cultural e divulgação espaços culturais dos territórios."),
    "text:home-opportunities.description" => i::__("Faça a sua inscrição ou acesse o resultado de diversas convocatórias como editais, oficinas, prêmios e concursos. Você também pode criar o seu próprio formulário e divulgar uma oportunidade para outros agentes culturais."),
    "text:home-entities.events" => i::__("Você pode pesquisar eventos culturais nos campos de busca do seu interesse que ajudam na  precisão de sua pesquisa. Como usuário cadastrado, você pode incluir seus eventos na plataforma e divulgá-los gratuitamente. Tudo isso de forma simples, rápida e acessível para toda a comunidade."),
