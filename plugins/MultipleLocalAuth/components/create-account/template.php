                ...
                <form class="col-12 grid-12" @submit.prevent="nextStep();">
                    ...
                    <div class="field col-12">
                        <label class="document-label" for="cpf"> 
                            ...
                            <div class="question">
                                <VMenu class="popover">
                                    <button tabindex="-1" class="question" type="button"> <?= i::__('Por que solicitamos este dado') ?> <mc-icon name="question"></mc-icon> </button>
                                    <template #popper>
                                        <?= i::__(
        'O CPF é seu documento de identidade<br>nacional e garante a segurança e a<br>transparência em todas as ações realizadas por<br>você na plataforma.<br><br>
        <b>Ao solicitar o CPF, estamos assegurando que:</b><br>
        - <b>Seu cadastro seja único:</b> Cada pessoa tem direito a apenas um CPF,<br>evitando duplicidades e fraudes.<br>
        - <b>Seus dados sejam protegidos:</b> O CPF é utilizado para confirmar sua identidade<br>e evitar que outras pessoas se cadastrem em seu nome.'
    ) ?>
                                    </template>
                                </VMenu>
                            </div>
